...
>(({ className, ...props }, ref) => (
  <div className="border-lighter/50 bg-light relative w-full overflow-auto rounded-lg border">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "even:bg-lighter/50 hover:bg-lighter data-[state=selected]:bg-muted transition-colors",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={cn("text-muted-foreground sr-only mt-4 text-sm", className)}
    {...props}
  />
));
